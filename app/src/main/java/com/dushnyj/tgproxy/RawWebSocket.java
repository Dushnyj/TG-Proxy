...
public class RawWebSocket {
    ...
    private static final SSLSocketFactory relaxedSslFactory = buildRelaxedSslFactory();
    ...
    public static RawWebSocket connect(String ip, String domain, int timeout, String path) throws Exception {
        return connect(ip, domain, timeout, path, true);
    }

    public static RawWebSocket connect(String ip, String domain, int timeout,
                                       String path, boolean relaxedTls) throws Exception {
        ...
        SSLSocketFactory factory = relaxedTls ? relaxedSslFactory : sslFactory;
    ...
    private static SSLSocketFactory buildRelaxedSslFactory() {
        try {
            ...
            context.init(null, trustAll, rng);
