...
`Отклик MTProto` открывает отдельное соединение к фактическому endpoint активного route и не
зависит от того, открыт ли Telegram или создаёт ли он сейчас трафик.
...
6. Нажмите `Сохранить TXT` или `Сохранить ZIP`.
